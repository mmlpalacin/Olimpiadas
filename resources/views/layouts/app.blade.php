...
.contenedor__caracteristicas, .contenedor__descripcion { margin-bottom: 20px; }
.contenedor__caracteristicas { padding: 20px; border: 1px solid #d8d8d8; border-radius: 8px; box-shadow: 0 10px 8px #c3c3c3; font-family: Arial, sans-serif; line-height: 1.6; }
...
.contenedor__detalles { padding: 20px; border: 1px solid #d8d8d8; border-radius: 8px; box-shadow: 0 10px 8px #c3c3c3; font-family: Arial, sans-serif; }
.contenedor__descripcion { padding: 20px; border: 1px solid #d8d8d8; border-radius: 8px; box-shadow: 0 10px 8px #c3c3c3; font-family: Arial, sans-serif; }
